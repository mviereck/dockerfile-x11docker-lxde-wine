...
echo [Desktop Entry]     > $HOME/Desktop/Winetricks.desktop      \n\
echo Version=1.0         >> $HOME/Desktop/Winetricks.desktop     \n\
echo Type=Application    >> $HOME/Desktop/Winetricks.desktop     \n\
echo Name=winetricks     >> $HOME/Desktop/Winetricks.desktop     \n\
echo Exec=winetricks     >> $HOME/Desktop/Winetricks.desktop     \n\
echo Icon=winetricks     >> $HOME/Desktop/Winetricks.desktop     \n\

echo [Desktop Entry]     > $HOME/Desktop/Wineregedit.desktop     \n\
echo Version=1.0         >> $HOME/Desktop/Wineregedit.desktop    \n\
echo Type=Application    >> $HOME/Desktop/Wineregedit.desktop    \n\
echo Name=regedit        >> $HOME/Desktop/Wineregedit.desktop    \n\
echo Exec=regedit        >> $HOME/Desktop/Wineregedit.desktop    \n\
echo Icon=wine           >> $HOME/Desktop/Wineregedit.desktop    \n\
' > $DESKTOPICONS
RUN chmod +x $DESKTOPICONS
